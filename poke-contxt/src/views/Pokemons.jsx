...
const Pokemons = () => {
  ...
  return (
    <form className="custom-select-container" onSubmit={handleSubmit}>
      ...
      <select id="mySelect" className="custom-select" value={selectedValue} onChange={handleSelectChange}>
      ...
      {selectedValue && <h2>Te gustaría ver mas información de {selectedValue}?</h2>}
